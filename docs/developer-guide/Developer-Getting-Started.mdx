...
Requires [Paper](https://papermc.io/software/paper) 1.21 and higher, [Velocity](https://papermc.io/software/velocity) 3.3.0 and higher, [Fabric](https://fabricmc.net/) 26.1+ or [Sponge](https://spongepowered.org/) API 12+.

To continue, you first need knowledge of [MiniMessage](https://docs.adventure.kyori.net/minimessage/index.html). To see how to use the MiniMessage API in MiniPlaceholders, [check this section](docs/developer-guide/MiniMessage-API-in-MiniPlaceholders.md).
...
## Minestom ![](https://img.shields.io/maven-central/v/io.github.miniplaceholders/miniplaceholders-minestom?style=flat-square)

Check the [full guide](docs/developer-guide/Minestom-Development.md)
